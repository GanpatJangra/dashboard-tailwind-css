...
let demoOptions = {
  ...
  'columns-thin': {
    series: [{
      ...
      data: [99200, 68400, 72111, 65020, 62000, 71000, 84232]
    }, {
      name: 'Total visitors',
      data: [112001, 92402, 86240, 97201, 72102, 102011, 98212]
    }],
    chart: {
      type: 'bar',
      height: 300,
  ...
  columns: {
    series: [{
      data: [300, 400, 200, 350, 500, 400, 300, 200, 100, 400, 500, 300, 400, 200, 100, 300, 400, 200, 350, 500, 400, 300, 200, 100, 400, 500, 300, 400, 200, 100, 250]
    }],
    chart: {
      height: 200,
      type: 'bar',
