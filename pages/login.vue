      ...
      <div class="flex flex-wrap items-center -mx-10">
        <div class="w-full lg:w-1/2 px-10">
          <div class="border px-6 lg:px-20 py-12 lg:py-24 bg-white shadow-2xl rounded-lg">
            <form action="#">
              <h3 class="mb-10 text-2xl font-bold font-heading">Login Account</h3>
              <div class="flex items-center pl-6 mb-3 border border-gray-200 bg-white rounded-full">
                ...
                <input class=" w-full pr-6 pl-4 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="email" placeholder="example@shuffle.dev">
              </div>
              <div class="flex items-center pl-6 mb-3 border border-gray-200 bg-white rounded-full">
                <span class="inline-block pr-3 border-r border-gray-50">
              ...
              <nuxt-link to="/signup" class="py-5 px-32 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">SignUp</nuxt-link>
            </form>
          </div>
        </div>
        <div class="w-full lg:w-1/2 px-10 mb-16 lg:mb-0 order-first lg:order-last">
          <div class="max-w-md">
            <span class="text-lg text-blue-500 font-bold">Login Account</span>
