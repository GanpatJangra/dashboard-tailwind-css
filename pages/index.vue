        ...
        <div class="container px-4 mx-auto">
          <div class="flex flex-wrap -m-4">
            <div class="w-full lg:w-1/2 p-4">
              <div class="p-6 mb-8 bg-gray-100 shadow rounded">
              ...
              <div class="bg-gray-100 rounded">
                <div class="flex items-center py-5 px-6 border-b">
                  ...
                  <div class="ml-auto inline-block py-2 px-3 border rounded text-xs text-gray-500">
                    <select class="pr-1 focus:outline-0" name="">
      ...
      <section class="pb-8">
        <div class="container px-4 mx-auto">
          <div class="flex flex-wrap -m-4">
            ...
            <div class="w-full lg:w-1/4 p-4">
              <div class="p-6 bg-white rounded">
                <h3 class="text-xl font-bold">Returns</h3>
                <div class="chart" data-type="radial-bar"></div>
              </div>
            </div>
          </div>
              ...
              <table class="table-auto w-full">
                <thead>
                  <tr class="text-xs text-gray-500 text-left">
                    ...
                    <th class="pb-3 font-medium">Subscription</th>
                    <th class="pb-3 font-medium">Status</th>
                  </tr>
                </thead>
                <tbody>
                  <tr class="text-xs bg-gray-50">
                    <td class="py-5 px-6 font-medium">GH443gh7484</td>
                    <td class="font-medium">08.04.2021</td>
                    <td class="font-medium">demo.@gmail.com</td>
...
<script>
import "../assets/js/charts-demo.js";
