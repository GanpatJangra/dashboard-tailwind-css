...
<section class="py-5 2xl:py-10 overflow-hidden">
  <div class="container px-4 mx-auto">
    <div class="max-w-5xl mx-auto">
      <div class="flex flex-wrap items-center -mx-10">
        <div class="w-full lg:w-1/2 px-10">
          <div class="border px-6 lg:px-20 py-12 lg:py-24 bg-white shadow-2xl rounded-lg">
            <form action="#">
              <h3 class="mb-10 text-2xl font-bold font-heading">sign Up Account</h3>
              <div class="flex items-center pl-6 mb-3 border border-gray-200 bg-white rounded-full">
                ...
                <input class=" w-full pr-6 pl-4 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="name" placeholder="Full Name">
              </div>
              <div class="flex items-center pl-6 mb-3 border border-gray-200 bg-white rounded-full">
                <span class="inline-block pr-3 border-r border-gray-50">
                  <svg class="w-5 h-5" width="20" height="21" viewbox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input class=" w-full pr-6 pl-4 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="email" placeholder="user@gmail.com">
              </div>
              <div class="flex items-center pl-6 mb-3 border border-gray-200 bg-white rounded-full">
                <span class="inline-block pr-3 border-r border-gray-50">
                ...
                <input class="w-full pr-6 pl-4 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none" type="password" placeholder="Password">
              </div>
            
              <div class="inline-flex mb-5">
                <input class="mr-4" type="checkbox">
                <p class="-mt-2 text-sm text-gray-500">By singning up, you agree to our <a class="text-gray-900" href="#">Terms, Data Policy</a>and <a class="text-gray-900" href="#">Cookies.</a></p>
              </div>
              <button class="py-4 my-5 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">Get started</button>
              <nuxt-link to="/signup" class="py-5 px-[133px] bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">Login</nuxt-link>
            </form>
          </div>
        </div>
        <div class="w-full lg:w-1/2 px-10 mb-16 lg:mb-0 order-first lg:order-last">
          <div class="max-w-md">
            <span class="text-lg text-blue-500 font-bold">sign Up Account</span>
            <h2 class="mt-8 mb-12 text-10xl font-bold font-heading">Start creating a new template by selecting UI components</h2>
            <p class="text-lg text-gray-500">
              <span>Lorem ipsum dolor sit amet.</span>
              <span class="font-bold">Hello lorem text</span>
            </p>
          </div>
        </div>
      </div>
